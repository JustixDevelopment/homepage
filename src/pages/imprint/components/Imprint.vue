<template>
  <div class="w-full max-w-4xl px-5 py-4 lg:py-10">
    <h1>Imprint</h1>
    <div class="mt-2 flex flex-col gap-2">
      ...
      <p>
        ...
        time at which a concrete infringement of the law becomes known. If we become aware of any
      ...
      <p>
        ...
        operator, the copyrights of third parties are respected. In particular, third-party content
        is identified as such. Should you nevertheless become aware of a copyright infringement,
        please inform us accordingly. If we become aware of any infringements, we will remove such
        content immediately.
      </p>
